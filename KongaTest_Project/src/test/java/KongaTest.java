...
public class KongaTest {
    ...
    driver.findElement(By.id("username")).sendKeys("atoyegbe@mailinator.com");
...
public void CardDetails() throws InterruptedException {
    ...
    driver.findElement(By.xpath("//*[@id=\"card-number\"]")).sendKeys("5399834448335878");
    // input card date on date field
    driver.findElement(By.xpath("//*[@id=\"expiry\"]")).sendKeys("1224");
    // input cvv number in cvv field
    driver.findElement(By.xpath("//*[@id=\"cvv\"]")).sendKeys("977");
    Thread.sleep(5000);
    }
 ...
 *5. Input your email address or phone number on the email or phone number field
 *6. Input your password on the password field
 *7. Click on the login button
 *8. Hover on All Categories
 *9. Click on MacBooks
 *10. Add an item to cart
 ...
 * //WebElement paymentMethod = driver.findElement(By.tagName("iframe"));
 * //        driver.switchTo().frame("kpg-frame-component");
 * WebElement cardPaymentMethod = driver.findElement(By.className("Card"));
 *         cardPaymentMethod.click();
 *         Thread.sleep(10000);
 *         WebElement message = driver.findElement(By.xpath("//*[@id=\"card-number_unhappy\"]"));
 *         System.out.println(message.getText());
 *
 *         return driver.findElement(By.xpath("//*[@id=\"card-number_unhappy\"]")).getText();
 */
